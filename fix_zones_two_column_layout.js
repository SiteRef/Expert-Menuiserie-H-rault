...
function generateTwoColumnZonesSection(citySlug) {
    ...
    let html = `        <!-- ZONES COUVERTES SECTION -->
        <section class="zones-section">
            <div class="container">
                ...
                <!-- Two column layout: Left = Image + Communes, Right = Quartiers -->
                <div class="grid grid-2" style="gap: var(--spacing-2xl); align-items: start;">

                    <!-- LEFT COLUMN: Image + Communes Limitrophes -->
                    <div class="zones-left-column">
                        ...
                        <div style="margin-top: var(--spacing-xl);">
                            ...
                            <div class="cities-grid" style="grid-template-columns: repeat(2, 1fr); gap: var(--spacing-md); margin-top: var(--spacing-lg);">`;
...
function processFile(filePath, citySlug) {
    try {
        ...
        // Generate two-column zones section
        const zonesHTML = generateTwoColumnZonesSection(citySlug);
...
console.log('Updating to two-column layout: Image + Communes (left) | Quartiers (right)...');
    ...
    if (dir.isDirectory()) {
        ...
        if (fs.existsSync(indexPath)) {
            ...
            if (processFile(indexPath, dir.name)) {
                processedCount++;
                console.log(`✓ ${dir.name} - Two-column layout updated`);
            } else {
